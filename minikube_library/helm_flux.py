...
subjects:
  - kind: ServiceAccount
	...
	# Stick to version 1.10.1, as 1.11.0 is broken.
	s.send('kubectl apply -f https://github.com/weaveworks/flux/blob/1.10.1/deploy-helm/flux-helm-release-crd.yaml',note='create CRD for flux')
